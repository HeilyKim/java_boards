...
public class MemberRestController {
    @Autowired
    private MemberService service; //interface에서 implement된 MemberServiceImpl를 불러오는데 하나면 걍 아무이름이면됨
    ...
    public Map<String, Object> checkLoginId(@Valid IdCheckDTO dto, Errors errors) throws Exception {
        if (errors.hasErrors()) {
    ...
    public Map<String, Object> joinMember(@Valid JoinDTO dto, Errors errors) throws Exception {
    ...
    public Map<String, Object> updateMember(@Valid UpdateDTO dto, Errors errors) throws Exception {
        if (errors.hasErrors()) {
            throw new Exception("잘못된 접근입니다.");
        }
    ...
    public Map<String, Object> findId(@Valid FindIdDTO dto, Errors errors) throws Exception {
        if (errors.hasErrors()) {
            throw new Exception("잘못된 접근입니다.");
        }
    ...
    public Map<String, Object> findPassword(HttpServletRequest request, @Valid FindPasswordDTO dto, Errors errors) throws Exception {
        if (errors.hasErrors()) {
            throw new Exception("잘못된 접근입니다.");
        }
    ...
    public Map<String, Object> updatePassword(HttpServletRequest request, @Valid PasswordUpdateDTO dto, Errors errors) throws Exception {
        if (errors.hasErrors() || !dto.getPassword().equals(dto.getPasswordCheck())) {
